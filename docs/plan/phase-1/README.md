...
| 文档编号 | 文档名称 | 说明 |
|----------|----------|------|
| 01 | [directory-structure.md](./01-directory-structure.md) | 项目目录结构设计 |
| 02 | [project-configuration.md](./02-project-configuration.md) | Python 项目配置 |
| 03 | [config-management.md](./03-config-management.md) | 配置管理模块设计 |
| 04 | [logging-system.md](./04-logging-system.md) | 日志系统设计 |
| 05 | [exception-handling.md](./05-exception-handling.md) | 异常处理体系设计 |
| 06 | [config-template.md](./06-config-template.md) | 配置文件模板 |
...
| `src/exceptions/__init__.py` | 异常类定义 | [ ] |
| `config/settings.yaml.example` | 配置模板 | [ ] |
| `.env.example` | 环境变量模板 | [ ] |
